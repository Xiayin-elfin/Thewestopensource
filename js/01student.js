...
$(function(){
    ...
    function showtime(){
        timer2=setInterval(function(){
            ...
            $(".ul_bear_students_introduce").animate({"margin-left":-200*num+"px"},3000,"linear",function(){
                if(num>=$(".li_bear_students_introduce").length-5){
    ...
    /*$(".span_position").each(function(){
        $(this).hover(function(){
            clearInterval(timer2);
        },function(){
            showtime();
        }).click(function(){
            if($(this).attr("class")=="span_left"){
                num++;
                $(".ul_bear_students_introduce").animate({"margin-left":-200*count+"px"},3000,"linear",function(){
                    if(num>=$(".li_bear_students_introduce").length){
                        $(".ul_bear_students_introduce").css("margin-left","0px");
                        num=0;
                    }
                });
                ...
                num--;
                if(num<0){
                    num=$(".li_bear_students_introduce").length-2;
                    $(".ul_bear_students_introduce").css("margin-left","-200px");
                }
                $(".ul_bear_students_introduce").animate({"margin-left":-200*count+"px"},3000,"linear");
            }
        });
    });*/
});